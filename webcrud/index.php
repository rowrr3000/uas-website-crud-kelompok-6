...
<head>
     ...
     <title>website data magang</title>
</head>

<body background="img/bg/bgn.jpg">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">manajemen data magang</a>
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    <h4 class="fw-bold text-uppercase">KELOMPOK 6</h4>
                    <br><br><br>
                    <p>
                          Firadilla,
                         Fitrohtul jannah,
